...
def main():
    ...
    rows_c2 = int(input("Enter number of rows for Matrix B (must equal columns of A): "))
    if rows_c2 != cols_c1:
        raise ValueError("Number of rows in Matrix B must equal number of columns in Matrix A.")
